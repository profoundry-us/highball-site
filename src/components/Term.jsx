...
export default function Term({ bar, right, lines, className = '' }) {
  return (
    ...
    >
      {bar && (
        <div className="flex items-center gap-2 px-3.5 py-2.5 border-b line font-mono text-xs text-neutral-content/50">
          <Dots />
...
export function Window({ title, children, className = '' }) {
  return (
    ...
    >
      <div className="flex items-center gap-2 h-9 px-3 border-b line bg-base-200 font-mono text-[11px] text-base-content/50">
        <Dots />
...
export const Dim = ({ children }) => <span className="text-neutral-content/45">{children}</span>;
